...
public class NotificationUtils {
    ...
    public static void notifyWear(Context context) {
        Uri weatherUri = WeatherContract.WeatherEntry
                .CONTENT_URI;
        String selection = WeatherContract.WeatherEntry.getSqlSelectForTodayOnwards();
        Cursor cursor = context.getContentResolver()
                .query(weatherUri, WEATHER_NOTIFICATION_PROJECTION, selection, null, null);
        ...
        if (cursor.moveToFirst()) {
            ...
            dataMap.getDataMap().putString(WEATHER_DATA_HIGH, SunshineWeatherUtils.formatTemperature(context, high));
            dataMap.getDataMap().putString(WEATHER_DATA_LOW, SunshineWeatherUtils.formatTemperature(context, low));
